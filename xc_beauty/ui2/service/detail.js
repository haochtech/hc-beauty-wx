...
Page({
    ...
    submit: function(a) {
        ...
        1 == a.currentTarget.dataset.flash && (e += "&flash=1"), "" != t.data.list.parameter && null != t.data.list.parameter && 1 != t.data.list.is_flash ? -1 == t.data.kind ? t.setData({
            ...
            url: e + "&kind=" + t.data.kind_name + "&kind_index=" + (t.data.kind + 1)
        }) : wx.navigateTo({
            url: e
        });
    },
    ...
    onShareAppMessage: function() {
        var a = this, t = "/xc_beauty/ui2/service/detail?&id=" + a.data.list.id, e = "/xc_beauty/pages/base/base?&share=" + (t = escape(t)), i = 1;
