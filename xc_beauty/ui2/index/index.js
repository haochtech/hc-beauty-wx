...
Page({
    ...
    imageLoad: function(a) {
        ...
        console.log(t, e);
        var e = 750 / n, d = this.data.imgheights;
        d.push(e), this.setData({
            imgheights: d
        });
    },
                        ...
                        if ("" != t.data) {
                            if ("" != t.data.banner && null != t.data.banner && l.setData({
                                ...
                                for (var n = t.data.flash, e = 0; e < n.length; e++) {
                                    var d, s, o, i;
                                    d = parseInt(parseInt(n[e].fail) / 86400), s = parseInt((n[e].fail - 86400 * d) / 3600), 
                                    o = parseInt((n[e].fail - 86400 * d - 3600 * s) / 60), i = parseInt(n[e].fail % 60), 
                                    n[e].day = d, n[e].hour = s, n[e].min = o, n[e].second = i;
                                }
                                l.setData({
                                    flash: n
                                }), time_up(l);
                            ...
                            if ("" != t.data.pclass && null != t.data.pclass && l.setData({
                                ...
                                prize: t.data.prize
                            }), "" != t.data.audit && null != t.data.audit && (l.setData({
                                audit: t.data.audit
                            }), app.audit = t.data.audit), "" != t.data.sort && null != t.data.sort) l.setData({
                                sort: t.data.sort
                            }); else {
                                l.setData({
                                    sort: [ {
