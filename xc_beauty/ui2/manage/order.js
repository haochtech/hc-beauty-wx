...
Page({
    ...
    to_check: function(a) {
        var t = a.currentTarget.dataset.index, e = a.currentTarget.dataset.status;
        this.setData({
            check_content: "",
            check_menu: !0,
            shadow: !0,
    ...
    check_input: function(a) {
        this.setData({
            check_content: a.detail.value
        });
    },
    check_btn: function() {
        var t = this, e = t.data.list, s = t.data.order_item, a = t.data.check_status, r = t.data.check_content;
        "" != r && null != r ? 1 == a ? app.util.request({
            url: "entry/wxapp/manage",
            data: {
                op: "order_check",
                id: e[s].id,
            ...
            success: function(a) {
                "" != a.data.data && (wx.showToast({
                    title: "操作成功"
                }), e[s].yu_check_result = 1, t.setData({
                    list: e,
                    check_menu: !1,
                    shadow: !1
                }));
            ...
            success: function(a) {
                "" != a.data.data && (wx.showToast({
                    title: "操作成功"
                }), e[s].yu_check_result = 2, t.setData({
                    list: e,
                    check_menu: !1,
                    shadow: !1
                }));
