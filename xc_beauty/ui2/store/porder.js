...
function sign(a) {
    var t = a.data.time_curr, e = a.data.name, d = (a.data.mobile, a.data.member_id), i = a.data.service_id, s = a.data.service_type, r = "";
    1 == a.data.online_time && -1 == t && (r = "请选择时间"), "" != e && null != e || (r = "请选择预约人"), 
    "" != d && null != d || (r = "请选择服务人员"), "" != i && null != i || (r = "请选择服务项目"), 
    -1 == s && (r = "请选择服务方式"), "" == r ? a.setData({
        submit: !0
    }) : wx.showModal({
        title: "错误",
        content: r,
        success: function(a) {
            a.confirm ? "请选择预约人" == r && wx.navigateTo({
...
Page({
    ...
    tab: function(a) {
        ...
        e != t.data.service_type && (t.setData({
            ...
            service_id: "",
            service_name: ""
        }), get_time(t), getPackage(t), getArea(t));
    },
    qie: function() {
        var e = this;
        if (1 == e.data.more_store && -1 != e.data.id) {
            e.setData({
                store_page: !0,
                store_list: []
            });
    ...
    date_right: function() {
        ...
        if (-1 == e) if (a.data.date_curr < a.data.date.length - 1) a.setData({
            ...
            d = a.data.date;
            var i = {};
            i.index = d[a.data.date_curr].index + 1, i.plan_date = GetDate(i.index), i.date = GetDateStr(i.index), 
    ...
    submit: function(a) {
      ...
      // if (!uInfo.wxInfo || null == uInfo.wxInfo) {
      //   console.log('aaaa');
      //   t.setData({
      //     shadow: !0,
      //     get_userinfo: !0
    ...
    onLoad: function(e) {
        ...
        var n = d.data.config, c = -1, u = -1, o = -1;
        "" != n && null != n && ("" != n.home_status && null != n.home_status && (c = n.home_status), 
        "" != n.shop_status && null != n.shop_status && (u = n.shop_status), "" != n.online_time && null != n.online_time && (o = n.online_time)), 
        d.setData({
            home_status: c,
            online_time: o,
            shop_status: u
