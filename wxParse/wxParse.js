...
function wxParse() {
    ...
    var d = {};
    d[e] = s, r.setData(d), r.setData({
        canshow: r.data.canshow + 1
    }), r.wxParseImgLoad = wxParseImgLoad, r.wxParseImgTap = wxParseImgTap;
}
...
function wxAutoImageCal(t, i, o, r) {
    ...
    return wx.getSystemInfo({
        success: function(e) {
            ...
            console.log("autoWidth" + n), d = n * i / t, console.log("autoHeight" + d), m.imageWidth = n, 
